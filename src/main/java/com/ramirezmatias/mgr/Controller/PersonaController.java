...
public class PersonaController {
    ...
    public ResponseEntity<?> create(@RequestBody DtoPersona dtoPersona){
        ...
        Persona persona = new Persona(dtoPersona.getNombre(), dtoPersona.getApellido(),dtoPersona.getDescrip(), dtoPersona.getImg());
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody DtoPersona dtoPersona) {
        ...
        if(!personaService.existsByNombre(dtoPersona.getNombre()) && personaService.getByNombreExp(dtoPersona.getNombre()).get().getId() != id)
